...
/**
 * BallerinaTracer marks pre and post instruction invocations to be used with tracing.
 *
 * @since 0.96.1
 */
public class BallerinaTracer {
    ...
    private BallerinaTracer() {

    }

    public BallerinaTracer(boolean traceEnabled) {
